...
menu_box1 = Rect(200,100,150,30)
menu_box2 = Rect(200,150,150,30)
menu_box3 = Rect(200,200,150,30)
menu_boxs = [menu_box1,menu_box2,menu_box3]

# các nút cộng trừ và save trong setting
setting_box1 = Rect(200,100,20,20)
setting_box2 = Rect(400,100,20,20)
setting_box3 = Rect(200,150,20,20)
setting_box4 = Rect(400,150,20,20)
setting_box5 = Rect(200,200,20,20)
setting_box6 = Rect(400,200,20,20)
...
def draw():
    if tab ==0 : # màn hình menu
        ...
        screen.draw.text('New game',(240,110),color=BLUE,fontsize=20)
        screen.draw.text('Options',(240,160),color=BLUE,fontsize=20)
        screen.draw.text('Information',(240,210),color=BLUE,fontsize=20)
    elif tab ==1 : # màn hình setting 
        screen.fill((64,196,49))
        for box in setting_boxs:
            screen.draw.filled_rect(box,GRAY)
        i_setting_box1 = Rect(230,100,quantity_e_tank*32,20)
        i_setting_box2 = Rect(230,150,quantity_a_tank*40,20)
        i_setting_box3 = Rect(230,200,150,30)
        ...
        screen.draw.text(f"{quantity_e_tank}",(300,100),color=TIM,fontsize=20)
        screen.draw.text('Allied Tanks',(100,150),color="black",fontsize=20)
        screen.draw.text(f"{quantity_a_tank}",(300,150),color=TIM,fontsize=20)
        screen.draw.text('Level',(100,200),color="black",fontsize=20)
        screen.draw.text('Save',(610,355),color="red",fontsize=20)
        screen.draw.text(text_dokho[index_dokho],(285,205),color=TIM,fontsize=25)
    elif tab ==2 : # màn hình information
        screen.fill((64,196,49))
        screen.draw.text('Developer',(240,80),color="gray",fontsize=50)
        screen.draw.text('Do Thi Xuan Quynh',(50,150),color="black",fontsize=20)  
        screen.draw.text('MSV : B19DCCN544',(50,180),color="black",fontsize=20)
        screen.draw.text('Class : NULL',(50,210),color="black",fontsize=20)
        screen.draw.text('SDT : 0908307112',(50,240),color="black",fontsize=20)
        screen.draw.text('Nguyen Hoang Viet',(250,150),color="black",fontsize=20)  
        screen.draw.text('MSV : B19DCCN714',(250,180),color="black",fontsize=20)
        screen.draw.text('Class : D19CQCN12-B',(250,210),color="black",fontsize=20)
        screen.draw.text('SDT : 0979342104',(250,240),color="black",fontsize=20)
        screen.draw.text('Dao Trong Phuc',(450,150),color="black",fontsize=20)  
        screen.draw.text('MSV : B19DCCN504',(450,180),color="black",fontsize=20)
        screen.draw.text('Class : D19CQCN12-B',(450,210),color="black",fontsize=20)
        screen.draw.text('SDT : 0963991723',(450,240),color="black",fontsize=20)
